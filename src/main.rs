/// example implementation sourced from: https://github.com/kube-rs/kube-rs/blob/master/examples/configmapgen_controller.rs
/// 
/// This is a toy operator implementation that generates a ConfigMap from a custom resource
